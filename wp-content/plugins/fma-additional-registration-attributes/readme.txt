...
Tags: woocommerce registration fields, woocommerce custom registration fields, woocommerce register plugin, woocommerce register, woocommerce registration, woocommerce registration form, woocommerce registration plugin, free, woocommerce
...
Woocommerce Registration plugin allows you to add extra custom fields to customer registration form. You can add text, checkbox and 3 other types of fields. WooCommerce Registration fields plugin is a powerful tool that lets you grab personal and business related information from customers in a hassle free manner.

Get more features in the Pro version of  [Custom Registration Form Plugin](https://www.fmeaddons.com/woocommerce-plugins-extensions/customer-registration-plugin.html "Custom Registration Form") e.g
...
### Key Benefits Of WooCommerce Registration Plugin ###
...
### Key Features Of WooCommerce Registration Form Plugin ###
...
WooCommerce custom registration form plugin allows you to add different types of custom fields so that users can quickly fill the registration form by selecting options from the dropdown or multiple selection menus. 
...
#### More Features Of WooCommerce Custom Registration Form ####
...
Here are some more useful resource that will optimize your website for more visitors, and more conversions.

[ Woocommerce Checkout Field Editor Plugin](https://www.fmeaddons.com/woocommerce-plugins-extensions/additional-checkout-fields.html "Custom Checkout Field Editor Woocommerce") 

You will be able to customize your checkout page, add new fields, which will be displayed on admin, invoice etc.

[ Woocommerce Tabs Plugin ](https://www.fmeaddons.com/woocommerce-plugins-extensions/product-custom-tabs.html "Woocommerce Tabs Plugin")

Organize your data in different tabs which are customizable.
...
* New Feature Added: Additional Fields are shown in the admin panel in user edit page.
* New Feature Added: Additional fields are sent in admin email.
...
= 1.0.3 =
Make compatible with woocommerce 3.0 that is major release, also introduce some new features so upgrade immediately.

= 1.0.2 =
Some vary important bugs/erros has been fixed in this new version release. Please update asap.

= 1.0.1 =
Some vary important bugs/erros has been fixed in this new version release.
...
1. screenshot-1.png is for the default titles settings.

2. screenshot-2.png is the registration fields drag and drop form.

3. screenshot-3.png is the represenation of the additional registration fields that are shown on the registratio page in profile info section.

4. screenshot-4.png is the represenation of the additional registration fields and value entered by customer that are shown on my account page.
