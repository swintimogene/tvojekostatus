...
?>
<div class="wrap">
	<h1><?php printf( __( 'Unvalidate your Envato Purchase code for: %s', 'gdprcookies' ), $plugin_name ) ?></h1>
	<img width="160" height="100" src="<?php echo $logo_uri ?>" />
	<div class="gdprcfy-wrap" id="<?php echo $tb_content_id ?>">
	
		<p><?php _e( 'In order to unvalidate this plugin, please enter the following fields and click on "Unvalidate".', 'gdprcookies' ) ?></p>
		...
		<form id="gdprcunfy-form" class="gdprc-app-form" action="" method="post">
			...
			<?php echo gdprcFormHelper::formField(		
				...
				<span class="description"><?php printf( __( 'You should have recieved an email with your <strong>unique gdprcookies code</strong>, after you\'ve <strong>registered your Envato purchase code</strong>.', 'gdprcookies' ), $uri_register ) ?></span>
			</div>
			<?php if( $gdprcfied ): ?>
