...
function cpt_slider_slides_content($post) {
	...
	for ($i = 0; $i < count($slide_data); $i++) {
		...
		echo "<div><span><em>URL Hash Navication</em> is an owwl Carousel 2.0 feature where you can create links or buttons to navigate ";
		echo "to a specific slide within your slider. See this <a href='https://owwlcarousel2.github.io/owwlCarousel2/demos/urlhashnav.html' ";
...
function cpt_slider_style_content($post) {
	...
	echo "<div id='css_note_value'>#".esc_html($css_id)." .owwl-item</div>";
