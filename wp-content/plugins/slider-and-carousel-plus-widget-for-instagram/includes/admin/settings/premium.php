...
<div class="wrap">
	...
	<h2><?php _e( 'Insta Feed - Features', 'slider-and-carousel-plus-widget-for-instagram' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Insta Feed</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Insta Feed</strong> and <strong>all other products</strong> with a single purchase.</p>
