...
if(!class_exists('EPO_i18n')):

class EPO_i18n {
	const TEXT_DOMAIN = 'woocommerce-epo';
	const ICL_CONTEXT = 'woocommerce-epo';
	...
	public function load_plugin_textdomain() {
		...
		load_textdomain(self::TEXT_DOMAIN, WP_LANG_DIR.'/woocommerce-epo/'.self::TEXT_DOMAIN.'-'.$locale.'.mo');
		load_plugin_textdomain(self::TEXT_DOMAIN, false, dirname(EPO_BASE_NAME) . '/languages/');
	}
