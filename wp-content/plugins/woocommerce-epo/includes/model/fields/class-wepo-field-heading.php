<?php
/**
 * Custom product field Heading data object.
 *
	...
	/*public function get_html(){
		...
		if($this->enabled){
			...
			if($this->title){
				...
				$title_html .= $this->__wepo($this->title);
			...
			if($this->subtitle){
				...
				$subtitle_html .= $this->__wepo($this->subtitle);
			...
			if($conditions_data_str){
				$cssclass_str .= empty($cssclass_str) ? 'epo-conditional-field' : ' epo-conditional-field';
			}
