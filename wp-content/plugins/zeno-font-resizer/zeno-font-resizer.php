...
function zeno_font_resizer_place( $echo = true ) {
	...
	<div class="zeno_font_resizer_container">
		<p class="zeno_font_resizer" style="text-align: center; font-weight: bold;">
			<span>
				<a href="#" class="zeno_font_resizer_minus" title="' . esc_attr__( 'Zmenšiť veľkosť textu', 'zeno-font-resizer' ) . '" style="font-size: 0.7em;">' .
					get_option('zeno_font_resizer_letter') . '<span class="screen-reader-text"> ' . __('Zmenšiť veľkosť textu.', 'zeno-font-resizer') . '</span>' .
				'</a>
				<a href="#" class="zeno_font_resizer_reset" title="' . esc_attr__( 'Štandardná veľkosť textu', 'zeno-font-resizer' ) . '">' .
					get_option('zeno_font_resizer_letter') . '<span class="screen-reader-text"> ' . __('Štandardná veľkosť textu.', 'zeno-font-resizer') . '</span>' .
				'</a>
				<a href="#" class="zeno_font_resizer_add" title="' . esc_attr__( 'Zväčšiť veľkosť textu', 'zeno-font-resizer' ) . '" style="font-size: 1.3em;">' .
					get_option('zeno_font_resizer_letter') . '<span class="screen-reader-text"> ' . __('Zväčšiť veľkosť textu.', 'zeno-font-resizer') . '</span>' .
				'</a>
			</span>
