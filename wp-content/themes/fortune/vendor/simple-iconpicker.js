...
jQuery(document).ready(function(){
    if (typeof fortune_customizer_settings !== "undefined") {
        if (fortune_customizer_settings.number_action > 0) {
            jQuery('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + fortune_customizer_settings.action_url + '">' + fortune_customizer_settings.number_action + '</a>');
        }
    }
    ...
    jQuery('#input_fortune_service_icon1').iconpicker('#input_fortune_service_icon1');
    jQuery('#input_fortune_service_icon2').iconpicker('#input_fortune_service_icon2');
    jQuery('#input_fortune_service_icon3').iconpicker('#input_fortune_service_icon3');

    jQuery('.iconpicker').mouseover(function(){ jQuery(this).css('border-color','red');});
    jQuery('.iconpicker').mouseout(function(){ jQuery(this).css('border-color','#ddd');});
        ...
        jQuery(this).focusin(function() {
            ...
            jQuery(".howl-iconpicker .geticonval").on('click', function() {
                ...
                if ( jQuery(selector).attr('class') == whichInputClass && jQuery(selector).attr('id') == whichInputId) {
                    jQuery(selector).val('fa fa-'+getIconId).change();
                }
            });
